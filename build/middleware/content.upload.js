...
exports.updatePoster = exports.uploadImgContent = void 0;
const path_1 = __importDefault(require("path"));
const uuid_1 = require("uuid");
const content_services_1 = require("../services/content.services");
const fs_1 = __importDefault(require("fs"));
const uploadImgContent = (req, res, next) => {
    var _a;
    if (req.files === null || !((_a = req.files) === null || _a === void 0 ? void 0 : _a.imgPoster)) {
        return res.status(400).json({ message: 'Tidak ada foto' });
    }
    const file = req.files.imgPoster;
    ...
    try {
        file.mv(`./public/poster/${fileName}`, (error) => __awaiter(void 0, void 0, void 0, function* () {
            if (error)
...
exports.uploadImgContent = uploadImgContent;
const updatePoster = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (req.files === null) {
        ...
        const file = (_a = req.files) === null || _a === void 0 ? void 0 : _a.imgPoster;
        const fileSize = file.data.length;
        const ext = path_1.default.extname(file.name);
...
//# sourceMappingURL=content.upload.js.map